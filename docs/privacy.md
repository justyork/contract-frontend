...
We may share data with trusted subprocessors (e.g., cloud hosting, analytics, infrastructure providers) strictly for service delivery. All subprocessors are contractually bound to implement appropriate data protection safeguards. For information about third-party services used by the Service, see [section 12 of our Terms of Use](/terms#12-third-party-services).
...
Requests can be submitted via the contact details in [section 16](#16-contact-and-data-protection) below. We will respond within the time limits required by applicable law (e.g., one month under GDPR, subject to extensions where permitted).
...
We may use essential cookies and privacy-friendly analytics to improve the Service. For detailed information about our use of cookies, please see our [Cookie Policy](/cookie-policy).
...
"Personal data" and "processing" have the meaning given in applicable data protection law (e.g., GDPR). "Service" and "User" are as defined in the [Terms of Use](/terms).
